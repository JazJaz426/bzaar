...
/**
 * The ViewCSVHandler class checks whether a csv has been loaded and if so, displays the data in a
 * response map
 */
public class ViewCSVHandler implements Route {
  ...
  /**
   * Handles the request to view a CSV file.
   *
   * @param request
   * @param response
