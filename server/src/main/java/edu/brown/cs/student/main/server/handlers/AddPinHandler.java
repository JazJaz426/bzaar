...
public class AddPinHandler implements Route {
  ...
  /**
   * Invoked when a request is made on this route's corresponding path e.g. '/hello' Adds a new pin
   * to the user's firestore db with the given lat/long
   *
  ...
  public Object handle(Request request, Response response) {
    ...
    try {
      ...
      responseMap.put("latitude", lat);
      responseMap.put("longitude", lon);
    } catch (Exception e) {
