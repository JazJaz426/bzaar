...
/** This class defines methods to get the state code from API Census Data */
public class GetStateCodes {

  /**
   * Method to get a map containing statecodes and corresponding statenames
   *
   * @return Map<String, String> map containing statecodes and statenames
   */
   ...
   *
   * @param String json
   * @return Hashmap of stateCodes in the form Map<String, String>
   * @throws IOException if json adaptor errors
   */
  ...
  /**
   * Method that sends an API request to retrieve state code data
   *
